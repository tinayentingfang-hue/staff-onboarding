...
- *Past history:* ✏️ Search → type the item the patient wrote → find in drug class/ingredient/specific product/non-drug/other → optionally add severity and comments → Save.
- *Allergy:* ✏️ Add → search (e.g. "hypertension") → tick active or inactive → untick everything else (e.g. include in summaries/save as reason for visit) → Save. If none known: View Record → Reactions → tick "Nil known."
